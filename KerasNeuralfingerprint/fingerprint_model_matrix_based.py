...
def neural_fingerprint_layer(inputs, atom_features_of_previous_layer, num_atom_features, conv_width, fp_length, L2_reg, num_bond_features , batch_normalize = True):
    ...
    This implementation uses matrices with binary entries to select and sum the features of neighboring atoms, and to map atoms in the batch to the indiviual molecules in the batch.
    '''
...
def build_fingerprint_regression_model(fp_length = 50, fp_depth = 4, conv_width = 20, 
    ...
    if 1:
        ...
        neural_fingerprint = layers.merge(all_outputs_to_fingerprint, mode='sum') 
